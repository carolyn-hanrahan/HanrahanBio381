...
```{r}
iris2 <- select(iris, Species, Sepal.Length, Sepal.Width)
...
# Question 9 
Create a ‘longer’ data frame using the original iris data set with three columns named “Species”, “Measure”, “Value”.
